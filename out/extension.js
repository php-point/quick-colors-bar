...
class ColorPanelProvider {
    constructor(_extensionUri, _statusBarDisplay) {
        this._extensionUri = _extensionUri;
        this._statusBarDisplay = _statusBarDisplay;
        this.colors = [];
...
ColorPanelProvider.viewType = 'colorPalette.view';
// Status bar color display
class StatusBarColorDisplay {
    constructor() {
        this.lastCopiedColor = '';
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider(ColorPanelProvider.viewType, provider));
